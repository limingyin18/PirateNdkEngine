...
bool PinchDetector::GetPointers(vector<int32_t>& v1, vector<int32_t>& v2) {
    ...
    v1 = vector<int32_t>(x, y);
    v2 = vector<int32_t>(x2, y2);
...
bool DragDetector::GetPointer(vector<int32_t>& v) {
